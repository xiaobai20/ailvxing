...
import cn.kgc.itrip.biz.service.ItripProductStoreService;
import cn.kgc.itrip.dao.mapper.ItripProductStoreMapper;
import cn.kgc.itrip.bean.model.ItripProductStore;
...
public class ItripProductStoreServiceImpl implements ItripProductStoreService {
    ...
    public Page<List<ItripProductStore>> queryItripProductStorePageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
