...
import cn.kgc.itrip.biz.service.ItripHotelExtendPropertyService;
import cn.kgc.itrip.dao.mapper.ItripHotelExtendPropertyMapper;
import cn.kgc.itrip.bean.model.ItripHotelExtendProperty;
...
public class ItripHotelExtendPropertyServiceImpl implements ItripHotelExtendPropertyService {
    ...
    public Page<List<ItripHotelExtendProperty>> queryItripHotelExtendPropertyPageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
