...
import cn.kgc.itrip.dao.mapper.ItripHotelRoomMapper;
import cn.kgc.itrip.bean.model.ItripHotelRoom;
...
public class ItripHotelRoomServiceImpl implements ItripHotelRoomService {
    ...
    public Page<List<ItripHotelRoom>> queryItripHotelRoomPageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
