...
import cn.kgc.itrip.biz.service.ItripHotelTempStoreService;
import cn.kgc.itrip.dao.mapper.ItripHotelTempStoreMapper;
import cn.kgc.itrip.bean.model.ItripHotelTempStore;
...
public class ItripHotelTempStoreServiceImpl implements ItripHotelTempStoreService {
    ...
    public Page<List<ItripHotelTempStore>> queryItripHotelTempStorePageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
