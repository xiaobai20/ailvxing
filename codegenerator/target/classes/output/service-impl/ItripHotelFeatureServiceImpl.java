...
import cn.kgc.itrip.biz.service.ItripHotelFeatureService;
import cn.kgc.itrip.dao.mapper.ItripHotelFeatureMapper;
import cn.kgc.itrip.bean.model.ItripHotelFeature;
...
public class ItripHotelFeatureServiceImpl implements ItripHotelFeatureService {
    ...
    public Page<List<ItripHotelFeature>> queryItripHotelFeaturePageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
