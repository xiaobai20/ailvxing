...
import cn.kgc.itrip.biz.service.ItripOrderLinkUserService;
import cn.kgc.itrip.dao.mapper.ItripOrderLinkUserMapper;
import cn.kgc.itrip.bean.model.ItripOrderLinkUser;
...
public class ItripOrderLinkUserServiceImpl implements ItripOrderLinkUserService {
    ...
    public Page<List<ItripOrderLinkUser>> queryItripOrderLinkUserPageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
