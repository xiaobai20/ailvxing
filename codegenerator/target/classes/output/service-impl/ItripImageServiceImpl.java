...
import cn.kgc.itrip.biz.service.ItripImageService;
import cn.kgc.itrip.dao.mapper.ItripImageMapper;
import cn.kgc.itrip.bean.model.ItripImage;
...
public class ItripImageServiceImpl implements ItripImageService {
    ...
    public Page<List<ItripImage>> queryItripImagePageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
