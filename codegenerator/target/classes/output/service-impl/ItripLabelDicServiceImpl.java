...
import cn.kgc.itrip.biz.service.ItripLabelDicService;
import cn.kgc.itrip.dao.mapper.ItripLabelDicMapper;
import cn.kgc.itrip.bean.model.ItripLabelDic;
...
public class ItripLabelDicServiceImpl implements ItripLabelDicService {
    ...
    public Page<List<ItripLabelDic>> queryItripLabelDicPageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
