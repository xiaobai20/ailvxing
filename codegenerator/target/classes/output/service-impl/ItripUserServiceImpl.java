...
import cn.kgc.itrip.biz.service.ItripUserService;
import cn.kgc.itrip.dao.mapper.ItripUserMapper;
import cn.kgc.itrip.bean.model.ItripUser;
...
public class ItripUserServiceImpl implements ItripUserService {
    ...
    public Page<List<ItripUser>> queryItripUserPageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
