...
import cn.kgc.itrip.biz.service.ItripHotelTradingAreaService;
import cn.kgc.itrip.dao.mapper.ItripHotelTradingAreaMapper;
import cn.kgc.itrip.bean.model.ItripHotelTradingArea;
...
public class ItripHotelTradingAreaServiceImpl implements ItripHotelTradingAreaService {
    ...
    public Page<List<ItripHotelTradingArea>> queryItripHotelTradingAreaPageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
