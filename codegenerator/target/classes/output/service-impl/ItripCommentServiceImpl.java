...
import cn.kgc.itrip.dao.mapper.ItripCommentMapper;
import cn.kgc.itrip.bean.model.ItripComment;
...
public class ItripCommentServiceImpl implements ItripCommentService {
    ...
    public Page<List<ItripComment>> queryItripCommentPageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
