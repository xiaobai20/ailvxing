...
import cn.kgc.itrip.biz.service.ItripAreaDicService;
import cn.kgc.itrip.dao.mapper.ItripAreaDicMapper;
import cn.kgc.itrip.bean.model.ItripAreaDic;
...
public class ItripAreaDicServiceImpl implements ItripAreaDicService {
    ...
    public Page<List<ItripAreaDic>> queryItripAreaDicPageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
