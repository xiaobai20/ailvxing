...
import cn.kgc.itrip.biz.service.ItripTradeEndsService;
import cn.kgc.itrip.dao.mapper.ItripTradeEndsMapper;
import cn.kgc.itrip.bean.model.ItripTradeEnds;
...
public class ItripTradeEndsServiceImpl implements ItripTradeEndsService {
    ...
    public Page<List<ItripTradeEnds>> queryItripTradeEndsPageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
